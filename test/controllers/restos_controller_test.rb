...
class RestosControllerTest < ActionController::TestCase
  ...
  test "should create resto" do
    assert_difference('Resto.count') do
      post :create, resto: { address: @resto.address, contact: @resto.contact, cuisine_id: @resto.cuisine_id, name: @resto.name }
    end
  ...
  test "should update resto" do
    patch :update, id: @resto, resto: { address: @resto.address, contact: @resto.contact, cuisine_id: @resto.cuisine_id, name: @resto.name }
    assert_redirected_to resto_path(assigns(:resto))
  end
